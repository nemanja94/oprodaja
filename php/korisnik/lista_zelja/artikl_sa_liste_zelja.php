...
if (isset($_SESSION['username'])) {
    ...
    <head>
        ...
        <title>Online prodaja - Detalji</title>
    </head>
    <body>
    <div>
        ...
        <div class="container">
            <div class="row">
                <h3>
                    ...
                    &nbsp;
                    &nbsp;
                    <a class="btn btn-sm btn-default" href="lista_zelja.php">Nazad</a>
                </h3>
                <br>
            </div>
            <table class="table table-responsive table-striped table-hover table-condensed">
                ...
                if ($row['artikl_kolicina'] > 0) {
                    ...
                    echo '<a class="btn btn-sm btn-success" href="dodaj_u_korpu.php?id=' . $id . '">Dodaj u korpu</a>';
                ...
                echo '</td>
                    <td>
                        <a class="btn btn-sm btn-danger" href="ukloni_zelju.php?id=' . $id . '">Ukloni</a>
                    </td>
                  </tr>';
