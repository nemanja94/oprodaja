        ...
        <div class="container">
            <div class="row">
                <h3>
                    ...
                    &nbsp;
                    &nbsp;
                    <a class="btn btn-sm btn-default" href="../katalog/katalog.php">Katalog</a>
                </h3>
                <br>
            </div>
            <table class="table table-responsive table-striped table-hover table-condensed">
                ...
                echo '<tr>
                    ...
                    <td class="text-right">
                        <a class="btn btn-sm btn-success" href="../kupi/dodaj_u_korpu.php?id=' . $id . '">Dodaj u korpu</a>
                        <a class="btn btn-sm btn-warning" href="../lista_zelja/dodaj_zelju.php?id=' . $id . '">Dodaj na istu želja</a>
                    </td>
                  </tr>';
