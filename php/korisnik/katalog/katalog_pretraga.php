...
if (isset($_SESSION['username']) && isset($_POST['pretraga_input']) && isset($_POST['pretraga_button'])) {
    ...
    $korisnicko_ime = htmlspecialchars($_SESSION['username']);
        ...
        <div class="container">
            <div class="row">
                <h3>
                    ...
                    &nbsp;
                    &nbsp;
                    <a class="btn btn-default" href="katalog.php">Katalog</a>
                </h3>
                <br>
            </div>
                ...
                while ($row = $query->fetch()) {
                    ...
                    if ($row['artikl_kolicina'] > 0) {
                        ...
                        <td class="text-right" >
                            ...
                            <a class="btn btn-sm btn-warning" href = "../lista_zelja/dodaj_zelju.php?id=' . $row['artikl_id'] . '" >Dodaj na istu želja </a >
                        </td >
                      </tr > ';
